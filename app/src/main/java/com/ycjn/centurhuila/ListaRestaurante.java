...
public class ListaRestaurante extends AppCompatActivity {
    ...
    FirebaseRecyclerAdapter<PostHotel, ListaViewHolder> firebaseRecyclerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listaRef = FirebaseDatabase.getInstance().getReference().child("CenturHuila/"+dato+"/Restaurantes");
        listaRef.keepSynced(true);

        mPostRV = (RecyclerView) findViewById(R.id.post_rv);
        mPostRV.setHasFixedSize(true);
        mPostRV.setLayoutManager(new LinearLayoutManager(ListaRestaurante.this));
    ...
    protected void onStart() {
        ...
        //de aqui para abajo lo del recicler de lista de restaurantes
        firebaseRecyclerAdapter= new FirebaseRecyclerAdapter<PostHotel, ListaViewHolder>
                (
                        PostHotel.class,
            ...
            @Override
            protected void populateViewHolder(ListaViewHolder viewHolder, PostHotel model, int position) {
                ...
                viewHolder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        ...
                        Intent intent = new Intent(ListaRestaurante.this, DescRestaurante.class);
