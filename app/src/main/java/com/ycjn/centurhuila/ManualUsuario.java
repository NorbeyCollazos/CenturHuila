...
import com.ycjn.centurhuila.model.MyPagerAdapter;
...
public class ManualUsuario extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        linBottom = findViewById(R.id.linearbottom);
        ...
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                if(position == layouts.length-1){
                    //LAST PAGE
                    btnNext.setText(getString(R.string.fin));
                    btnSkip.setVisibility(View.GONE);


                }else {

                    btnNext.setText(getString(R.string.sigui));
    ...
    private void startMainActivity(){
        ...
        startActivity(new Intent(ManualUsuario.this, InicioActivity.class));
        finish();
    }
