...
public class ListaHotel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listaRef = FirebaseDatabase.getInstance().getReference().child("CenturHuila/"+dato+"/Hoteles");
        listaRef.keepSynced(true);

        mPostRV = (RecyclerView) findViewById(R.id.post_rv);
        mPostRV.setHasFixedSize(true);
        mPostRV.setLayoutManager(new LinearLayoutManager(ListaHotel.this));
            ...
            protected void populateViewHolder(ListaViewHolder viewHolder, PostHotel model, int position) {
                ...
                viewHolder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        ...
                        Intent intent = new Intent(ListaHotel.this, DescHotel.class);
